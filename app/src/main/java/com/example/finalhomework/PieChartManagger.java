...
public class PieChartManagger {
    ...
    public PieChartManagger(PieChart pieChart,int which,float i) {//i判斷誰
        this.pieChart = pieChart;
        initPieChart(which,i);
    }

    //初始化
    private void initPieChart(int which,float i) {
        //  是否显示中间的洞
        ...
        if(which == 1) {
            ...
            pieChart.setCenterText(Float.toString(i)+"$"); //设置中间文字
        }
